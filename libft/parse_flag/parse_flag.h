...
FT_INLINE char *value_type_to_str(E_OptValueType type) {
    switch (type) {
        case OPT_NO_VALUE: return "OPT_NO_VALUE";
        case DECIMAL_VALUE: return "DECIMAL_VALUE";
        case HEXA_VALUE: return "HEXA_VALUE";
        case OCTAL_VALUE: return "OCTAL_VALUE";
        case BINARY_VALUE: return "BINARY_VALUE";
        case CHAR_VALUE: return "CHAR_VALUE";
        case CUSTOM_VALUE: return "CUSTOM_VALUE";
